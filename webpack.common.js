...
module.exports = {
    ...
    plugins: [
        ...
        // new HtmlWebPackPlugin({ template: './src/index2.html', filename: './index2.html', chunks: ['index2'] }),
        // new HtmlWebPackPlugin({ template: './src/index3.html', filename: './index3.html', chunks: ['index3'] }),
